...
{
    public RomanNumeralsTest(ITestOutputHelper testOutput)
    {
    ...
    [Fact]
    public void Number_is_less_than_zero()
    {
        Assert.Equal(string.Empty, (-1).ToRoman());
    }

    [Fact]
    public void Number_0_is_a_single_i()
    {
        Assert.Equal(string.Empty, 0.ToRoman());
    }
